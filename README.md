...
<div align="center">
  ...
  [![Version](https://img.shields.io/badge/version-4.7.1-blue.svg)](https://github.com/miounet11/claude-code-manager/releases)
...
### 🆕 v4.7.1 更新亮点
- **🐛 稳定性提升** - 修复了所有测试中发现的关键问题
- **🚀 代理服务器优化** - 修复动态路由请求转发错误
- **💻 终端改进** - 增强内存管理，防止泄漏
- **🧪 完整测试覆盖** - 新增测试套件，覆盖率达 72.73%
- **📚 文档完善** - 添加架构设计和构建指南
